               ...
               <div class="col-sm-9">
                    <div class="card card-member-content mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form class="update-profile-form" method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                                @csrf
                ...
                $.each(e.target.files, function (i, file) {
                    ...
                    reader.onload = function (event) {
                        if (file.type.match('image.*')) {
                            ...
                            //     var cropperModal = $('#modal-cropper-js');
                            ...
                            //     cropperImg.cropper({
                            //         aspectRatio: (cropperWidth / 3) / (cropperHeight / 3),
                            //         zoomOnWheel: false,
                            //         crop: function (e) {
                            //         }
                            //     });
                            ...
                            //         $(this).closest('.modal-cropper').modal('hide');
                            //         $('.account-profile-image').attr('src', imageData);
                            //     });
                            // });
