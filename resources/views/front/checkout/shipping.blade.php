...
@section('title', $title)
@section('content')
    <div class="page-shipping page-address py-3">
        <div class="container">
                    ...
                    <div class="col-6">
                        <div class="card mb-3">
                            <div class="card-body">
                                {{-- <div class="input-field mt-4">
                                    <div class="form-group">
                                        <label class="active" for="total"></label>
                                        <div class="form-control-static">
                                            <div class="subtotal" id="subtotal"></div>
                                            <input type="hidden" name="subtotal"
                                                id="subtotal" class="subtotal" value="" />
                                        </div>
                                    </div>
                                </div> --}}
                                <div class="input-field mt-4">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#postchoose").on('change', function() {
                ...
                var total = parseInt(ongkos_kirim); //(parseInt(subtotal)
                        ...
                        $.each(response.data, function(i, val) {
                            ...
                            $.each(val.costs, function(key2, value2) {
                                $.each(value2.cost, function(key3, value3) {
                                    $('select[name="postchoose"]').append('<option class="form-control" value="'+ value3.value +'">'+ value2.service + ' - ' + ("{{ config('cart.currency') }}" + Number(value3.value).format(2,3)) + ' - ' + value3.etd +'</option>');
                                });
                            });
                        });
                    } else {
