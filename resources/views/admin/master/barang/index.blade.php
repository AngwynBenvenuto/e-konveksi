        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <table id="barang_table" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                <th>Nama Barang</th>
                                <th>Dibuat pada</th>
    ...
    <script>
        $(document).ready(function() {
            var table = $("#barang_table").DataTable({
                ajax: "{{ route('admin.master.barang.show') }}",
                columns: [
                    { "data": "name" },
                    { "data": "created_at" },
                    { "data": "updated_at" },
            ...
            $(".btnAdd").click(function() {
                window.location.href = "{{ route('admin.master.barang.create') }}";
            });

            $("#barang_table").on('click', '.btnEdit', function () {
                var id = $(this).data('id');
                var url = '{{ route("admin.master.barang.edit", ":id") }}';
