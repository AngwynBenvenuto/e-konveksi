    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="div_back" class="" style="text-align:right;">
                <a id="" href="{{ route('admin.master.provinsi') }}" class="btn  btn-primary mb-2">
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form id="form_provinsi" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group" style="position:relative">
                                    <input type="text" class="form-control"
                                        placeholder="Zona.." id="zone"
                                        name="zone" value="{{ old('zone', $zone) }}"/>
                                </div>
                            </div>
                        </div>
