    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="div_back" class="" style="text-align:right;">
                <a id="" href="{{ route('admin.master.jasa') }}" class="btn  btn-primary mb-2">
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form id="form_jasa" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-8">
                                <div class="form-group" style="position:relative">
                                    <textarea class="form-control summernote" 
                                        placeholder="Deskripsi.." id="description" autocomplete="off"
    ...
    <script>
        $(document).ready(function() {        
            $(".btnBack").click(function() {
                window.location.href = "{{ route('admin.master.jasa') }}";
            });
