        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <table id="courier_table" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                <th>Nama courier</th>
                                <th>Dibuat pada</th>
    ...
    <script>
        $(document).ready(function() {
            var table = $("#courier_table").DataTable({
                ajax: "{{ route('admin.master.courier.show') }}",
                columns: [
                    { "data": "name" },
                    { "data": "created_at" },
                    { "data": "updated_at" },
            ...
            $(".btnAdd").click(function() {
                window.location.href = "{{ route('admin.master.courier.create') }}";
            });

            $("#courier_table").on('click', '.btnEdit', function () {
                var id = $(this).data('id');
                var url = '{{ route("admin.master.courier.edit", ":id") }}';
