                ...
                <div class="card-body">
                    <form id="form_review" method="post" enctype="multipart/form-data">
                        ...
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <span class="label " name="penjahit_name" id="penjahit_name">{{ $penjahit_name }}</span>
                            </div>
                            <input type="hidden" value="{{ $penjahit_id }}" id="penjahit_id" name="penjahit_id"/>
                        </div>
                        <div class="control-group ">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(error == 0) {
                            ...
                            setTimeout(function() {
                                $("#note").val();
                                var url = "{{ route('admin.project_data', ":id") }}";
